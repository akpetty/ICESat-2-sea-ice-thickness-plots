...
def getWinterDateRangev2(start_year, end_year): 
    ...
    winters += pd.date_range(start = str(2019) + '-09', end = str(2020) + '-04', freq = 'MS')
    winters += pd.date_range(start = str(2020) + '-09', end = str(2021) + '-04', freq = 'MS')
    winters += pd.date_range(start = str(2021) + '-09', end = str(2022) + '-03', freq = 'MS')
...
def calcMeans(dataset, extraStr='_filled'): 
...
def plotThicknessCompare(dataset, var='mean_ice_thickness', var_str = 'sea ice thickness', yearStart = 2018, regionsText = None, figPath = None, label=''):
    ...
    winterMonths2 = [1, 2, 3,4,5,6,7,8]
    winterMonthsStr2 = ['Sep', 'Oct', 'Nov','Dec','Jan','Feb','Mar','Apr']
    winterMonths3 = [1, 2, 3,4,5,6,7,8]
    winterMonthsStr3 = [ 'Sep', 'Oct','Nov','Dec','Jan','Feb','Mar','Apr']
    winterMonths4 = [1, 2, 3,4,5,6, 7]
    winterMonthsStr4 = [ 'Sep', 'Oct','Nov','Dec','Jan','Feb','Mar']
    ...
    ax.plot(winterMonths1, datasetWinter1[var].values, color = 'y', linestyle = '-', marker = 'o', markersize=4, alpha=0.9, label = winter1Str)
    ...
    ax.plot(winterMonths3, datasetWinter3[var].values, color = 'm', linestyle = '-', marker = 'o', markersize=4, label = winter3Str)
    if var=='mean_ice_thickness':
        ax.fill_between(winterMonths3, datasetWinter3[var].values - datasetWinter3['mean_ice_thickness_unc'].values, datasetWinter3[var].values + datasetWinter3['mean_ice_thickness_unc'].values, facecolor = 'k', alpha = 0.09, edgecolor = 'none')

    #plot data for winter 4
    datasetWinter4 = dataset.sel(time = slice('Sep ' + str(yearStart + 3), 'Mar' + str(yearStart + 4)))
    winter4Str = str(yearStart + 3)[0:4] + '/' + str(yearStart + 4)[0:4]
    color4 = 'k'
    ax.plot(winterMonths4, datasetWinter4[var].values, color = 'k', linestyle = '-', marker = 'o', markersize=4, label = winter4Str)
    if var=='mean_ice_thickness':
        ax.fill_between(winterMonths4, datasetWinter4[var].values - datasetWinter4['mean_ice_thickness_unc'].values, datasetWinter4[var].values + datasetWinter4['mean_ice_thickness_unc'].values, facecolor = 'k', alpha = 0.09, edgecolor = 'none')
    ...
    if var=='mean_ice_thickness':
        #add legend & labels
        ax.legend(loc =2, fontsize = 9, ncol=2, frameon=False)
...
regionMask, maskLons, maskLats = getRegionMask('/cooler/sea_ice_pso/aapetty/raw_data/OTHER/')
...
regionKeyList = [8, 9, 10, 11, 12, 13, 15] #Inner Arctic
...
plotThicknessCompare(is2means, var='mean_'+variable, var_str = variable, yearStart = 2018, regionsText = 'InnerArctic_incKaBa', figPath=figPath, label=relStr+'_'+str(endYear))
